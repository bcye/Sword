...
# Running the bot
Build the libraries with `swift build`, then type `.build/debug/yourswiftexecutablehere` (when using the new toolchain: `.build/x86_64-apple-macosx10.10/debug/yourswiftexecutablehere`)
